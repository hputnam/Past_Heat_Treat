...
ZD: Got it working by removing the NA columns. The output files are labelled with wells A1-D1 instead of A3-D3 but I think otherwise it is correct. Also had to remove the "." after Photo.Data$Time.Min, which fixed the time issue.
