...
ZD: Got it working by removing the NA columns. The output files are labelled with wells A1-D1 instead of A3-D3 but I think otherwise it is correct. Could not yet fix it for light level 5 but getting somewhere.
